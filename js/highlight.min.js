/*!
  Highlight.js v11.2.0 (git: 2aa387dccf)
...
var hljs = function () {
  ...
  const b = "[a-zA-Z]\\w*", m = "[a-zA-Z_]\\w*", E = "\\b\\d+(\\.\\d+)?", x = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", y = "\\b(0b[01]+)", w = {
  ...
  }, k = O("//", "$"), N = O("/\\*", "\\*/"), S = O("#", "$"); var R = Object.freeze({
        ...
        ; return e.classNameAliases = s(e.classNameAliases || {}), function n(r, o) {
          const a = r
            ; if (r.isCompiled) return a
              ;[A, B, X, L].forEach((e => e(r, o))), e.compilerExtensions.forEach((e => e(r, o))),
                r.__beforeBegin = null, [j, I, T].forEach((e => e(r, o))), r.isCompiled = !0; let l = null
    ...
    ; return (e => {
      const t = Object.create(null), r = Object.create(null), s = []; let o = !0
        ; const a = "Could not find the language '{}', did you forget to load/include a language module?", l = {
          ...
          let i = "", r = ""
            ...
            ; return o.code = s.code, w("after:highlight", o), o
        } function h(e, n, r, s) {
          const l = Object.create(null); function c() {
            if (!k.keywords) return void S.addText(R)
              ...
              ; for (; t;) {
                n += R.substring(e, t.index)
                  ; const r = _.case_insensitive ? t[0].toLowerCase() : t[0], s = (i = r, k.keywords[i]); if (s) {
                    const [e, i] = s
                      ; if (S.addText(n), n = "", l[r] = (l[r] || 0) + 1, l[r] <= 7 && (M += i), e.startsWith("_")) n += t[0]; else {
                        const n = _.classNameAliases[e] || e; S.addKeyword(t[0], n)
                      }
                  } else n += t[0]
                  ; e = k.keywordPatternRe.lastIndex, t = k.keywordPatternRe.exec(R)
              } var i
            ...
            null != k.subLanguage ? (() => {
              if ("" === R) return; let e = null; if ("string" == typeof k.subLanguage) {
                ...
                ; k.relevance > 0 && (M += e.relevance), S.addSublanguage(e._emitter, e.language)
            })() : c(), R = ""
          } function u(e, t) {
            ...
            return e.scope && "string" == typeof e.scope && S.openNode(_.classNameAliases[e.scope] || e.scope),
              e.beginScope && (e.beginScope._wrap ? (S.addKeyword(R, _.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
                R = "") : e.beginScope._multi && (u(e.beginScope, t), R = "")), k = Object.create(e, {
                  parent: {
                    value: k
                  }
                }), k
            ...
            return 0 === k.matcher.regexIndex ? (R += e[0], 1) : (I = !0, 0)
          } function x(e) {
                ...
                S.addKeyword(t, k.endScope._wrap)) : k.endScope && k.endScope._multi ? (d(),
                  u(k.endScope, e)) : s.skip ? R += t : (s.returnEnd || s.excludeEnd || (R += t),
                    d(), s.excludeEnd && (R = t)); do {
                      k.scope && S.closeNode(), k.skip || k.subLanguage || (M += k.relevance), k = k.parent
                    } while (k !== r.parent); return r.starts && p(r.starts, e), s.returnEnd ? 0 : t.length
          }
          let y = {}; function w(t, s) {
            const a = s && s[0]; if (R += t, null == a) return d(), 0
              ; if ("begin" === y.type && "end" === s.type && y.index === s.index && "" === a) {
                if (R += n.slice(s.index, s.index + 1), !o) {
              ...
              const t = e[0], n = e.rule, r = new i(n), s = [n.__beforeBegin, n["on:begin"]]
                ; for (const n of s) if (n && (n(e, r), r.isMatchIgnored)) return m(t)
                  ; return n.skip ? R += t : (n.excludeBegin && (R += t),
                    d(), n.returnBegin || n.excludeBegin || (R = t)), p(n, e), n.returnBegin ? 0 : t.length
            })(s)
              ; if ("illegal" === s.type && !r) {
              ...
              ; const v = G(_); let O = "", k = s || v; const N = {}, S = new g.__emitter(g); (() => {
                ...
                for (k.matcher.considerAll(); ;) {
                  j++, I ? I = !1 : k.matcher.considerAll(), k.matcher.lastIndex = A
                    ...
                    ; A = e.index + t
                } return w(n.substr(A)), S.closeAllNodes(), S.finalize(), O = S.toHTML(), {
                  language: e, value: O, relevance: M, illegal: !1, _emitter: S, _top: k
                }
              } catch (t) {
                if (t.message && t.message.includes("Illegal")) return {
                  ...
                  illegal: !0, relevance: 0, _illegalBy: {
                    ...
                    context: n.slice(A - 100, A + 100), mode: t.mode, resultSoFar: O
                  }, _emitter: S
                }; if (o) return {
      ...
      "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
        ...
        ; for (const e in R) "object" == typeof R[e] && n(R[e]); return Object.assign(e, R), e
    })({})
}()
  ; "object" == typeof exports && "undefined" != typeof module && (module.exports = hljs);
hljs.registerLanguage("gdscript", (() => {
  "use strict"; var e = e || {}; function r(e) {
    return {
      aliases: ["godot", "gdscript"], keywords: {
      ...
      }, contains: [e.NUMBER_MODE, e.HASH_COMMENT_MODE, {
        ...
        variants: [{
          ...
          className: "class",
          beginKeywords: "class"
        }], end: /:/, contains: [e.UNDERSCORE_TITLE_MODE]
      }]
    }
  }
  e.exports = e => { e.registerLanguage("gdscript", r) }, e.exports.definer = r
})());